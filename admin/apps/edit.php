...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
    <h1 style="margin: 0;">Edit App: <?= htmlspecialchars($app['name']) ?></h1>
...
<form method="POST" action="" class="app-card" style="max-width: 800px;">
    <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="name" value="<?= htmlspecialchars($app['name']) ?>" required style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
        <div style="margin-bottom: 15px;">
            <label style="display: block; margin-bottom: 8px; color: var(--text-secondary);">Slug (URL) *</label>
            <input type="text" name="slug" value="<?= htmlspecialchars($app['slug']) ?>" required style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
    </div>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <select name="category_id" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
                ...
                <?php foreach ($categories as $cat): ?>
                    <option value="<?= $cat['id'] ?>" <?= $cat['id'] == $app['category_id'] ? 'selected' : '' ?>><?= htmlspecialchars($cat['name']) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div style="margin-bottom: 15px;">
            <label style="display: block; margin-bottom: 8px; color: var(--text-secondary);">Developer</label>
            <input type="text" name="developer" value="<?= htmlspecialchars($app['developer']) ?>" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
    </div>
    ...
    <div style="margin-bottom: 15px;">
        ...
        <textarea name="description" rows="5" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;"><?= htmlspecialchars($app['description']) ?></textarea>
    </div>
    
    <div style="margin-bottom: 15px;">
        <label style="display: block; margin-bottom: 8px; color: var(--text-secondary);">Requirements</label>
        <textarea name="requirements" rows="3" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;"><?= htmlspecialchars($app['requirements']) ?></textarea>
    </div>
        ...
        <div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                ...
                <label style="display: flex; align-items: center; gap: 5px; color: var(--text-primary); cursor: pointer; font-size: 0.9rem;">
                    <input type="checkbox" name="is_apk_active" value="1" <?= $app['is_apk_active'] ? 'checked' : '' ?>> Active
                </label>
            </div>
            <input type="text" name="apk_download_link" value="<?= htmlspecialchars($app['apk_download_link']) ?>" placeholder="https://..." style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
        <div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                <label style="color: var(--text-secondary); margin: 0;">Play Store Link</label>
                <label style="display: flex; align-items: center; gap: 5px; color: var(--text-primary); cursor: pointer; font-size: 0.9rem;">
                    <input type="checkbox" name="is_play_store_active" value="1" <?= $app['is_play_store_active'] ? 'checked' : '' ?>> Active
                </label>
            </div>
            <input type="text" name="play_store_link" value="<?= htmlspecialchars($app['play_store_link']) ?>" placeholder="https://..." style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
        <div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                <label style="color: var(--text-secondary); margin: 0;">App Store Link</label>
                <label style="display: flex; align-items: center; gap: 5px; color: var(--text-primary); cursor: pointer; font-size: 0.9rem;">
                    <input type="checkbox" name="is_app_store_active" value="1" <?= $app['is_app_store_active'] ? 'checked' : '' ?>> Active
                </label>
            </div>
            <input type="text" name="app_store_link" value="<?= htmlspecialchars($app['app_store_link']) ?>" placeholder="https://..." style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
        <div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                <label style="color: var(--text-secondary); margin: 0;">Indus Appstore Link</label>
                <label style="display: flex; align-items: center; gap: 5px; color: var(--text-primary); cursor: pointer; font-size: 0.9rem;">
                    <input type="checkbox" name="is_indus_store_active" value="1" <?= $app['is_indus_store_active'] ? 'checked' : '' ?>> Active
                </label>
            </div>
            <input type="text" name="indus_store_link" value="<?= htmlspecialchars($app['indus_store_link'] ?? '') ?>" placeholder="https://..." style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
        <div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                <label style="color: var(--text-secondary); margin: 0;">Amazon Appstore Link</label>
                <label style="display: flex; align-items: center; gap: 5px; color: var(--text-primary); cursor: pointer; font-size: 0.9rem;">
                    <input type="checkbox" name="is_amazon_store_active" value="1" <?= $app['is_amazon_store_active'] ? 'checked' : '' ?>> Active
                </label>
            </div>
            <input type="text" name="amazon_store_link" value="<?= htmlspecialchars($app['amazon_store_link'] ?? '') ?>" placeholder="https://..." style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
    </div>
    ...
    <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
        <div style="margin-bottom: 15px;">
            ...
            <input type="date" name="publish_date" value="<?= htmlspecialchars($app['publish_date'] ?? '') ?>" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
        <div style="margin-bottom: 15px;">
            <label style="display: block; margin-bottom: 8px; color: var(--text-secondary);">App Update Date</label>
            <input type="date" name="app_update_date" value="<?= htmlspecialchars($app['app_update_date'] ?? '') ?>" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
        </div>
    </div>
    ...
    <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
        <div style="margin-bottom: 15px;">
            ...
            <select name="status" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: var(--bg-primary); color: var(--text-primary); outline: none;">
                ...
                <option value="published" <?= $app['status'] == 'published' ? 'selected' : '' ?>>Published</option>
            </select>
        </div>
        <div style="margin-bottom: 15px; display: flex; align-items: center; margin-top: 30px;">
            <input type="checkbox" name="is_featured" id="is_featured" value="1" <?= $app['is_featured'] ? 'checked' : '' ?> style="width: 20px; height: 20px; margin-right: 10px;">
            <label for="is_featured" style="color: var(--text-primary); cursor: pointer;">Feature this app on homepage</label>
        </div>
    </div>

    <div style="margin-top: 30px;">
        <button type="submit" class="btn btn-primary" style="padding: 15px 30px; font-size: 1.1rem;">Update App</button>
    </div>
</form>
